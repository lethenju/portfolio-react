      ...
      <div className="ProfilePanel_SidePane">
        ...
        {window.innerWidth >= 1000 ? (
          <div className="button_row">
            <a className="button_big" href="https://www.github.com/lethenju">
              GitHub
            </a>
            <a
              className="button_big"
              href="https://www.linkedin.com/in/julien-letheno/"
            >
              LinkedIn
            </a>
            <a className="button_big" href="mailto:julien.letheno@gmail.com">
              Send mail
            </a>
          </div>
        ) : (
        ...
        {props.language === "fr-FR" ? (
          <div>
            ...
            <p>
              ...
              <br />
              <br /> J'adore aussi travailler sur des projets personnels ! En
              voici quelques un :)
            </p>
          </div>
        ) : (
          <div>
            ...
            <p>
              ...
              <br />
              <br /> I also love working on side projects ! You can see a few of
              them below :)
            </p>
          </div>
        )}
